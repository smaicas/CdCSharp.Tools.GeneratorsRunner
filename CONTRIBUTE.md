...
Thank you for your interest in improving **[CdCSharp.GeneratorsRunner]**. Your help is greatly valued. 🙌
...
1. **🔍 Open an Issue**
   - If you have an idea, suggestion, or find a bug, open an [issue](https://github.com/smaicas/CdCSharp.Tools.GeneratorsRunner/issues) to discuss it before making significant changes.
...
5. **🔀 Submit a Pull Request**
   - When your change is ready, open a [Pull Request](https://github.com/smaicas/CdCSharp.Tools.GeneratorsRunner/pulls) for the review. Ensure your PR follows the code guidelines and standards.
